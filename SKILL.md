...
Si el robot no existe en la ruta esperada, ejecuta este comando de instalación desde GitHub:

```powershell
# Opción A: Clonar usando Git (Recomendado)
...
# Opción B: Descargar ZIP vía PowerShell (si Git no está instalado)
